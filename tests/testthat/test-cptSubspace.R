...
test_that("Default arguments produce no errors",{
		  expect_s4_class(cptSubspace(X=dataAMOC,subspaceDim=5),"cptCovariance")
		  expect_s4_class(cptSubspace(X=dataNull,subspaceDim=5),"cptCovariance")
})

test_that("Manual threshold works for rest of tests",{
		  expect_s4_class(cptSubspace(X=dataAMOC,subspaceDim=5,threshold='Manual',thresholdValue=10),"cptCovariance")
})
...
test_that("Data is correct format",{
		  ...
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='Manual',thresholdValue=10),"cptCovariance")
		  expect_s4_class(cptSubspace(dataAMOCdataFrame,subspaceDim=5,threshold='Manual',thresholdValue=10),"cptCovariance")
...
test_that("Threshold type is correct",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='PermTest'),"cptCovariance")
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='Manual'),"cptCovariance")
...
test_that("Number of changepoints is correct",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,numCpts='AMOC',threshold='Manual',thresholdValue=10),"cptCovariance")
		  expect_s4_class(cptSubspace(data2Change,subspaceDim=5,numCpts='BinSeg',threshold='Manual',thresholdValue=10),"cptCovariance")
		  expect_s4_class(cptSubspace(data2Change,subspaceDim=5,numCpts='BinSeg',threshold='PermTest',thresholdValue=0.05),"cptCovariance")
		  expect_s4_class(cptSubspace(data2Change,subspaceDim=5,numCpts=2,threshold='Manual',thresholdValue=10),"cptCovariance")
...
test_that("Threshold value is correct",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='PermTest',thresholdValue=0.05),"cptCovariance")
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='Manual',thresholdValue=30),"cptCovariance")
...
test_that("Minimum segment length is appropriate",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,msl=ncol(dataAMOC)+5,threshold='Manual',thresholdValue=10),"cptCovariance")
...
test_that("Number of permutations is appropriate",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,threshold='PermTest',thresholdValue=0.05,nperm=200),"cptCovariance")
...
test_that("Class argument is logical",{
		  expect_s4_class(cptSubspace(dataAMOC,subspaceDim=5,Class=TRUE,threshold='Manual',thresholdValue=10),"cptCovariance")
		  expect_type(cptSubspace(dataAMOC,subspaceDim=5,Class=FALSE,threshold='Manual',thresholdValue=10),"integer")
